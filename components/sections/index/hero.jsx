      ...
      <Container spacing={"VerticalXXXL"}>
        ...
        <section>
          <button
            ...
            // onClick={() => (window.location = "mailto:atayal99@gmail.com")}
            onClick={() =>
              window.open("https://www.calendly.com/aryantayal/15", "_blank")
            }
          >
          ...
          <button
            ...
            onClick={() =>
              window.open("https://www.linkedin.com/in/aryantayal/", "_blank")
            }
          >
